...
echo "</br>";
$result=mysqli_query($con, "select * from cash where (no_faktur like '%$key%') order by no_faktur DESC",$con); 
...
echo'<td><a href=\'javascript:window.open("modul/penjualan/cetakretur.php?no_faktur='.$tampil['no_faktur'].'", "WinC",
...
<script>
   function printPage()
   {
      ...
      div.innerHTML = \'<iframe src="../../modul/penjualan/cetakretur.php?no_faktur="FKT000000001" onload="this.contentWindow.print();"></iframe>\';
   }
</script>
</td>';
$no++;

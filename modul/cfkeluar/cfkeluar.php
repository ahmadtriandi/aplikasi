...
case "tampil";
echo "<center>";
echo '<span style="font-weight:bold">Lihat Data Pengeluaran</span><br><br>';
Echo '
<form action="modul/cfkeluar/cetakcfkeluar.php" target="_blank" method="POST" name="postform"> ';
echo "
&nbsp; Dari Tanggal  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

...
==========================
<br><br>
<table style='width:260px; font-size:10pt; font-family:arial' border = '0'>
<tr><td align='left' style='align:left'>Tanggal: $tgl $bulan $thn</td></tr>
</table>

<table style='width:260px; font-size:10pt; font-family:arial' border = '0'>
<tr><td align='left'>No. Faktur: FKT$tmpmaks[no]</td></tr>
</table>

<table id='tabel' style='width:260px; font-size:10pt;' border='1'>
<tr align='center'>
<td width='60%'>Nama Barang</td>
<td width='10%'>Qty</td>
<td width='30%'>Harga</td></tr>";
$no=1;
$baris=1;
$diskon=0;
...
$hargarp="Rp".number_format($tampil['harga_jual']*$tampil['qty'],0,',','.');
echo"<td style='text-align:right'>$hargarp</td>";
//$tampilrupiah=number_format($tampil['total_harga'],2,',','.');
//echo"<td style='text-align:right'>Rp$tampilrupiah</td>";
$diskon=$diskon+($tampil['potongan']*$tampil['qty']);
}
echo"</tr>";
...
echo"
<tr>
<td colspan = '2'><div style='text-align:right'><b>Diskon : </b></div></td>
<td style='text-align:right'>Rp".number_format($diskon,0,',','.')."</td>
</tr>";
echo"
<tr>
<td colspan = '2'><div style='text-align:right'><b>Total : </b></div></td>
<td style='text-align:right'>Rp".number_format($tampilkan['total_harga'],0,',','.')."</td>
</tr>";



//echo "<tr><td colspan = '3'><div style='text-align:left'><b>Terbilang :</b>".ucwords(Terbilang($tampilkan['total_harga']))." Rupiah</div></td></tr>";
...
<td style='text-align:right'>Rp".number_format($bayar,0,',','.')."</td>
</tr>";

echo"<tr>
<td colspan = '2'><div style='text-align:right'><b>Kembalian : </b></div></td>
<td style='text-align:right'>Rp".number_format($kembalian,0,',','.')."</td>
</tr>";
}
if ($_POST['jenisbayar'] == "DP"){
$dp = $bayar;
...
<td align='center'>TTD,</br></br></br></br><u>(________________)</u></td>
</tr>-->";
echo"</table></center>
</body>";
